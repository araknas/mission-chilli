...
export const assets = [
  ...
  { name: 'Blue bed', url: './furnitures/blue-bed-1.png' },
  { name: 'Floor_wooden_1', url: './rooms/floor_2.png' },
  { name: 'Stars', url: './effects/stars-1.png' },
  { name: 'Start Button', url: './controls/start-button.png' },
];
